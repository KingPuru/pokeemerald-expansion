...
#define P_FLAG_FORCE_SHINY               0x496  // If this flag is set, all wild and gift Pokémon will forced into being Shiny.
#define P_FLAG_FORCE_NO_SHINY            0x497  // If this flag is set, all wild and gift Pokémon will forced into NOT being Shiny.
